...
setup_signing_and_ota() {
  case $ROM_NAME in
    pixelos)
      if [ ! -d vendor/extra/keys ] && [ ! -f vendor/extra/product.mk ]; then
        echo "Setting up signing"
        git clone git@github.com:Exynos9611Development/android_vendor_lineage-priv.git vendor/extra -b pixelos
      else
